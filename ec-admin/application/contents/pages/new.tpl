    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="row">
          <div class="col-md-12">
            <div class="widget">
              <div class="widget-header"><h4 class="widget-title">Создать страницу</h4><span>%{ec_admin profile login}%</span></div>
              ...
              <div class="widget-body">
                ...
                <input type="text" id="url" onchange="setCont('url', 'pageId');">
                ...
                <br>
                <textarea placeholder="Содержимое" id="content"></textarea>
                <p class="help-text">В содержимом можно использовать HTML теги!</p>
                <center><br><div id="click_send"><a href="javascript:addPage('title', 'content', 'url')" class="btn btn-primary" style="width: 60%;">Создать</a></div></center>
              </div>
            </div>
          </div>
        </div>
